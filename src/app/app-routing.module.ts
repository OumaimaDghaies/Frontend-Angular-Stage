  ...
  { path: '', redirectTo:'main', pathMatch: 'full' },
    //{ path: 'login', component: LoginComponent},
    {
        ...
        children: [
            ...
            //{ path: 'login', component: LoginComponent},
            //{ path: 'manageemployee', loadChildren: () => import('./manageemployeeT/manageemployee.module').then((m) => m.ManageEmployeeModule) },
            { path: 'managefamille', loadChildren: () => import('../app/managefamille/managefamille.module').then((m) => m.ManageFamilleModule) },
            { path: 'manageentreestock', loadChildren: () => import('../app/manageentreestock/manageentreestock.module').then((m) => m.ManageEntreeStockModule) },
            { path: 'managecalendar', loadChildren: () => import('../app/managecalendar/managecalendar.module').then((m) => m.ManageCalendarModule) },
            { path: 'managegamme', loadChildren: () => import('../app/managegamme/managegamme.module').then((m) => m.ManageGammeModule) },
            { path: 'managefamillepfini', loadChildren: () => import('../app/managefamilleproduitfini/managefamilleproduitfini.module').then((m) => m.ManageFamilleProduitFiniModule) },
            { path: 'manageproduitfini', loadChildren: () => import('../app/manageproduitfini/manageproduitfini.module').then((m) => m.ManageProduitFiniModule) },
            { path: 'managearticle', loadChildren: () => import('../app/managearticle/managearticle.module').then((m) => m.ManageArticleModule) },
            { path: 'managepreparation', loadChildren: () => import('../app/managepreparation/managepreparation.module').then((m) => m.ManagePreparationModule) },
            { path: 'managetypepanne', loadChildren: () => import('../app/managetypepanne/managetypepanne.module').then((m) => m.ManageTypepanneModule) },
            { path: 'managepanne', loadChildren: () => import('../app/managepanne/managepanne.module').then((m) => m.ManagePanneModule) },
            
            { path: 'manageimmobilisation', loadChildren: () => import('../app/manageimmobilisation/manageimmobilisation.module').then((m) => m.ManageImmobilisationModule) },
            { path: 'manageemployee', loadChildren: () => import('../app/manageemployee/manageemployee.module').then((m) => m.ManageEmployeeModule) },
            { path: 'manageintervention', loadChildren: () => import('../app/manageintervention/manageintervention.module').then((m) => m.ManageInterventionModule) },
            { path: 'managetypeoperation', loadChildren: () => import('../app/managetypeoperation/managetypeoperation.module').then((m) => m.ManageTypeOperationModule) },
            { path: 'managetypemateriel', loadChildren: () => import('../app/managetypemateriel/managetypemateriel.module').then((m) => m.ManageTypeMaterielModule) },
            { path: 'manageoperation', loadChildren: () => import('../app/manageoperation/manageoperation.module').then((m) => m.ManageOperationModule) },
            
            /* { path: 'manageterritory', loadChildren: () => import('../app/manageterritory/manageterritory.module').then((m) => m.ManageTerritoryModule) },
            { path: 'managedepartment', loadChildren: () => import('../app/managedepartment/managedepartment.module').then((m) => m.ManageDepartmentModule) },
            { path: 'managepayoffice', loadChildren: () => import('../app/managepayoffice/managepayoffice.module').then((m) => m.ManagePayOfficeModule) },
            { path: 'manageloancategory', loadChildren: () => import('../app/manageloancategory/manageloancategory.module').then((m) => m.ManageLoanCategoryModule) },
            { path: 'managecontract', loadChildren: () => import('../app/managecontract/managecontract.module').then((m) => m.ManageContractModule) },
            { path: 'managecontractextension', loadChildren: () => import('../app/managecontractextension/managecontractextension.module').then((m) => m.ManageContractExtensionModule) },
            { path: 'mydata', loadChildren: () => import('../app/mydata/mydata.module').then((m) => m.MyDataModule) },
            { path: 'collaboratordata', loadChildren: () => import('./inputcollaboratordata/inputcollaboratordata.module').then((m) => m.InputCollaboratorDataModule) },
            { path: 'managecollaboratordata', loadChildren: () => import('./managecollaboratordata/managecollaboratordata.module').then((m) => m.ManageCollaboratorDataModule) },
            { path: 'approvallevel1', loadChildren: () => import('../app/approvallevel1/approvallevel1.module').then((m) => m.ApprovalLevel1Module) },
            { path: 'printcollaboratordata', loadChildren: () => import('../app/printcollaboratordata/printcollaboratordata.module').then((m) => m.PrintCollaboratorDataModule) },
            { path: 'managecollaborators', loadChildren: () => import('../app/managecollaborators/managecollaborators.module').then((m) => m.ManageCollaboratorsModule) },
            { path: 'manageemployeegps', loadChildren: () => import('./manageemployeegps/manageemployeegps.module').then((m) => m.ManageEmployeeGpsModule) },
            { path: 'updatemileagechargesstatus', loadChildren: () => import('./updatemileagechargesstatus/updatemileagechargesstatus.module').then((m) => m.UpdateMileageChargesStatusModule) },
            { path: 'resetemployeepassword', loadChildren: () => import('./resetemployeepassword/resetemployeepassword.module').then((m) => m.ResetEmployeePasswordModule) },
            { path: 'depreciationstate', loadChildren: () => import('./depreciationstate/depreciationstate.module').then((m) => m.DepreciationStateModule) },
            { path: 'userprofile', loadChildren: () => import('./userprofile/userprofile.module').then((m) => m.UserProfileModule) },
            { path: 'approvalwithdrawalrequest', loadChildren: () => import('./approvalwithdrawalrequest/approvalwithdrawalrequest.module').then((m) => m.ApprovalWithdrawalRequestModule) },
            */
            /*{
                { path: 'userprofile', loadChildren: () => import('./userprofile/userprofile.module').then((m) => m.UserProfileModule) }, path: 'gab', loadChildren: () => import('../app/gab/gab.module').then((m) => m.GabModule) },
            { path: 'accessfees', loadChildren: () => import('../app/accessfees/accessfees.module').then((m) => m.AccessFeesModule) },
            { path: 'stationcommission', loadChildren: () => import('../app/stationcommission/stationcommission.module').then((m) => m.StationCommissionModule) },
            { path: 'dailycheck', loadChildren: () => import('../app/dailycheck/dailycheck.module').then((m) => m.DailyCheckModule) },
            { path: 'authorizationstatistics', loadChildren: () => import('../app/authorizationstatistics/authorizationstatistics.module').then((m) => m.AuthorizationStatisticsModule) },
            { path: 'bankinvoice', loadChildren: () => import('../app/bankinvoice/bankinvoice.module').then((m) => m.BankInvoiceModule) },*/
            //{ path: 'importpos', component: ImportposfileComponent },
