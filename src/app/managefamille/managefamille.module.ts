...
import { ManageFamilleDataRoutingModule } from './managefamille-routing.module';
...
@NgModule({
    imports: [
        CommonModule, 
        FormsModule,
        ManageFamilleDataRoutingModule,
        TableModule,
        ButtonModule,
        ToolbarModule,
        DialogModule,
    ...
    declarations: [ManageFamilleComponent,FamilleComponent,]
})
